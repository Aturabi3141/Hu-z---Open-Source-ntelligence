...
p1 = PhotoImage(file = 'Ekran_Alıntısı.png')
...
giris.pack(padx=15,pady=20,anchor=NW)

giris3=Label(frame_alt_sol,text="1-) Genaral Engine araması",bg='#808080',font="Verdana 14 bold").pack(padx=10,pady=10,anchor=NW)

giris4=Label(frame_alt_sol,text="2-) Meta Arama",bg='#808080',font="Verdana 14 bold").pack(padx=10,pady=10,anchor=NW)


giris5=Label(frame_alt_sol,text="3-) Ülkeler Arası Araması ",bg='#808080',font="Verdana 14 bold").pack(padx=10,pady=10,anchor=NW)

giris6=Label(frame_alt_sol,text="4-) Veri Tabanına Ekleme yap ",bg='#808080',font="Verdana 14 bold").pack(padx=10,pady=10,anchor=NW)

giris7=Label(frame_alt_sol,text="5-)Veri Tabanında Kişi Arat ",bg='#808080',font="Verdana 14 bold").pack(padx=10,pady=10,anchor=NW)

#resim=ImageTk.PhotoImage(Image.open('C://Users//irems//OneDrive//Masaüstü//EkranAlıntısı.png'))
